            ...
            <div className="grid grid-cols-1 gap-1 py-3 sm:grid-cols-3 sm:gap-4">
                ...
                <dd className="text-gray-700 sm:col-span-2">
                    <select onChange={(e) => {setType(e.target.value)}}>
                        ...
                        <option value="TWITTER_FOLLOW">TWITTER FOLLOW CHECK</option>
                        <option value="TWITTER_LIKE">TWITTER LIKE CHECK</option>
                        <option value="TWITTER_RETWEET">TWITTER RETWEET CHECK</option>
                    </select>
