            ...
            <div className='flex gap-10'>
                        ...
                        {/* {
                            limemonList[0]
                                ...
                                <div className='flex justify-center gap-5'>
                                    <select
                                        className="px-0.5 rounded-lg border-gray-300 text-gray-700"
                                    >
                                        <option value="JM">칭호1</option>
                                        <option value="JM">칭호2</option>
                                    </select>
                                    <input
                                        type="text"
                                        id="FirstName"
                                        name="first_name"
                                        className="px-0.5 rounded-md border-gray-200 bg-white"
                                    />
                                </div>
                                :
                                <div className='flex justify-center gap-5'>라임몬이름</div>
                        } */}
                        <div>
                ...
                <div className="border border-[#7c7a75] rounded-lg w-full">
                    <div className='text-center pt-[50%]  uppercase'>
                        <p className='SUITE-Heavy text-[5rem]'>stat</p>
