...
class LimemonLevelInfo extends Sequelize.Model {
   ...
   static init(sequelize) {
      ...
      return super.init(
         ...
         {  // 두번째 객체 인수는 테이블 자체에 대한 설정
            ...
            modelName: 'LimemonLevelInfo', /* 모델 이름을 설정. */
            tableName: 'limemon_level_info', /* 데이터베이스의 테이블 이름. */
...
module.exports = LimemonLevelInfo;